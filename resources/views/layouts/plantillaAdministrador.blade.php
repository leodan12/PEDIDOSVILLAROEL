    ...
    <div class="collapse navbar-collapse justify-content-start" filter-color="black" id="navigation"  filter-color="black" >
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a class="nav-link" rel="tooltip" title="Inicio" data-placement="bottom" href="/administrador">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a class="nav-link" rel="tooltip" title="Usuario Administrador" data-placement="bottom" href="#">
              <h5> ADMINISTRADOR</h5>       
            </a>
          </li>

          <li class="nav-item d-none d-sm-inline-block">
            <a class="nav-link" rel="tooltip" title="Agregar, Modificar y Eliminar usuarios" data-placement="bottom" href="/users">
    ...
    <!-- centro -->
        ...
        <header >
          ...
          <div class="container my-auto" style="position: absolute; top: 37%; left: 30%; height: 40%; margin: 0 0 0 -25%;">
            ...
            <h3 class="mb-5">
              <em>ASIGNACION DE CARGA HORARIA A DOCENTES </em>
            </h3>
